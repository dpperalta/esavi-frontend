...
// Mirrors the real nesting of app/router.tsx: AppShell → RequireRole(ADMIN) → /roles.
...
describe('Ruta /roles — navegación desde el sidebar', () => {
  it('el enlace del sidebar navega a la pantalla de roles', async () => {
...
describe('Ruta /roles — autorización (SPEC FE21 §3.1, §6: desviación declarada)', () => {
  ...
  it('con rol ANALYTICS tampoco se alcanza', async () => {
  ...
  it('con rol ADMIN entrar por URL sí muestra la pantalla', async () => {
    signInAs('ADMIN', 50);
