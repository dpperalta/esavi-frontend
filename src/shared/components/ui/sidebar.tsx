...
function SidebarProvider({
  ...
  // Same controlled/uncontrolled pattern as open/onOpenChange above, added for the mobile
  // drawer: lets a consumer keep openMobile in its own store (SPEC FE01 §3.4, uiStore) instead
  // of this component's internal state.
  openMobile?: boolean;
  ...
  const setOpenMobile = React.useCallback(
    (value: boolean | ((value: boolean) => boolean)) => {
      ...
      if (setOpenMobileProp) {
        setOpenMobileProp(openMobileState);
      } else {
